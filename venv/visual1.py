...
# sns.distplot(df_train['SalePrice'], color='red') # 将SalePrice可视化
...
# data.plot.scatter(x=var, y='SalePrice', color='red')
...
# fig = sns.boxplot(x=var,y="SalePrice", data = data,color='red')
...
# sns.heatmap(corrmat, vmax = 1, vmin = 0, square=True, cmap='Reds') # 相关矩阵和热力图
...
# # sns.heatmap(cm, vmax = 1, vmin = 0, cmap='GnBu') # 相关矩阵和热力图
# hm = sns.heatmap(cm, vmax = 1, vmin = 0, cmap='Reds', square=True,
...
# # plt.savefig("pictures/GrLivArea_SalePrice_scatter_figure_after_two_data.png")
# plt.show()
#
# var = 'GrLivArea'
# var = 'TotalBsmtSF'
# sns.distplot(df_train[var],color='red')
# plt.title("GrLivArea_probability_figure")
# plt.savefig("pictures/GrLivArea_probability_figure.png")

# var = 'TotalBsmtSF'
# plt.scatter(df_train[df_train[var]>0][var],df_train[df_train[var]>0]['SalePrice'], color='red')
...
# plt.scatter(df_train[var],df_train['SalePrice'],color='red')
...
plt.scatter(df_train[df_train[var]>0][var],df_train[df_train[var]>0]['SalePrice'],color='red')
# plt.scatter(df_train[var],df_train['SalePrice'],color='red')
plt.title(var + '_SalePrice_scatter_figure_loged_exceptZero')
# plt.savefig('pictures/' + var + '_SalePrice_scatter_figure_loged_exceptZero.png')
plt.show()
